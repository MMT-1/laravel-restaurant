...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="card mb-3">
                  <div class="card-body">
            <form class="m-5 mx-auto" method="post" action="{{url('/update',$data->id)}}" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <img src="/foodimage/{{$data->image}}" class="img-fluid" style="max-height:150px" alt="">
            </div>
